// Os operadores usados em JS são;
// + para a soma
// - menos para a subtração
// * para a multiplicação
// / para a divisão real
// % para a divisão inteira
// ** ara achar o quadrado do numero.
